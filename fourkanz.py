...
while 1:
    ...
    print("""{}
      __                  _
 / _| ___  _   _ _ __| | ____ _ _ __  ________
| |_ / _ \| | | | '__| |/ / _` | '_ \|_  /_  /
|  _| (_) | |_| | |  |   < (_| | | | |/ / / /
|_|  \___/ \__,_|_|  |_|\_\__,_|_| |_/___/___|
    ...
    if menu == 1:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + gönderimi başlatmak için enet tuşuna basss: "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasını gir lan: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "düzgün yaz lann") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "gönderimi başlatmak için  'enter' tuşuna basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "düzgün yaz ahmet.") 
            sleep(3)
            continue
        system("cls||clear")
        ...
        try:
            ...
            system("cls||clear")
            print("\n.       UYGULAMADAN ÇIKIŞ YAPILIYOR ALLAHA EMANET ♥️🤍")
            sleep(2)
